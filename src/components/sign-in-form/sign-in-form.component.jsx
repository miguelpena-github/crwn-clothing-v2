...
import { logInWithEmailAndPassword, createUserDocumentFromAuth, signInWithGooglePopup } from "../../utils/firebase/firebase.utils";
        ...
        <div className="sign-up-form-container">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="button-sign-in-container">
                    ...
                    <Button buttonType="google" type="submit" onClick={logGoogleUser}>Sign in with Google</Button>       
                </div>
